    ...
    <body>
        ...
        <div class = "Main_Content">
                <div class="medicines_box">
                    <a href= "http://localhost/Trial/Admin/Admin_Add_Medicine.php">
                        <button class="medicines_button"> Add Medicine </button>
                    </a>
                </div>

                <div class="companies_box">
                    <a href= "http://localhost/Trial/Admin/Admin_Add_Company.php">
                        <button class="companies_button"> Add Company </button>
                    </a>
                </div>

                <div class="types_box">
                    <a href= "http://localhost/Trial/Admin/Admin_Add_Type.php">
                        <button class="types_button"> Add Type </button>
                    </a>
                </div>

                <div class="ways_box">
                    <a href= "http://localhost/Trial/Admin/Admin_Add_Way.php">
                        <button class="ways_button"> Add Way </button>
                    </a>
                </div>
            </div>
